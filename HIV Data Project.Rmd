...
## Scatterplot of ART coverage vs. log(deaths) with regression line and confidence band 
...
## Coefficient plot comparing the ART coverage estimate across all three models with 95% CI bars
...
## Residuals vs. Fitted for model3
...
## Histogram of Residuals for model3
