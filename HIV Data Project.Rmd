...
author: 'STA198 Team: Natalie Alba, Ella Maroni, Jessica Perez, Ali Wilson'
date: "2026-04-10"
output:
  pdf_document:
...
The final dataset contains 170 countries, with each observation representing a single country. The primary variables used in the analysis are HIV/AIDS deaths (deaths), number of people living with HIV (hiv_population), and ART coverage (art_coverage). All variables are continuous numerical estimates.
