...
To examine the relationship between ART coverage and HIV/AIDS deaths, I conducted a correlation analysis and multiple linear regression models. I first tested the direct association between ART covergae and deaths, then included the number of people living with HIV as a control variable.
...
All in all, while ART coverage alone did not appear to influence deaths in the simple model, the controlled regression suggests that increased ART coverage is associated with reduced HIV/AIDS mortality when accounting for differences in HIV pop. size. This supports the hypotehsis that expanding access to antiretroviral therapy may help reduce HIV-related deaths globally.
...
A log-transformed multiple regression model was used to bettwe account for skewness in the data and examine the relationsip between ART coverage and HIV/AIDS deaths. The results showed...(Ella)
